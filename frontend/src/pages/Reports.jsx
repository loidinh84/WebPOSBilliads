...
function Reports() {
  ...
  const handlePieMouseMove = (e) => {
    ...
    // Kiểm tra xem chuột có nằm trong bán kính hình tròn không
    ...
    // Tính toán góc (độ), góc 0 bắt đầu từ hướng 12h theo chiều kim đồng hồ
  ...
  // Reset zoom và trang khi chuyển loại báo cáo
  ...
  // Xử lý Fullscreen (Bật chế độ xem toàn màn hình cho phần báo cáo)
    ...
    <div className="min-h-screen bg-[#F8F9FB] font-inter text-gray-900">
      ...
      <main className="max-w-[1440px] mx-auto p-4 md:p-6 grid grid-cols-12 gap-6 items-start">
        ...
        <section className="col-span-12 md:col-span-9 flex flex-col gap-4">
          {/* Biểu đồ chi phí (chỉ hiện khi là báo cáo chi phí) */}
          {!isRevenue && (
                ...
                >
                  {hoveredSlice && (
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gray-900/90 text-white rounded shadow-xl p-2 pointer-events-none z-10 flex flex-col items-center min-w-[90px] border border-gray-700">
                      <span className="text-[10px] text-gray-300 font-normal leading-tight mb-0.5">{hoveredSlice.label}</span>
                      <span className="font-bold text-lg leading-none" style={{ color: hoveredSlice.color }}>{hoveredSlice.percent}%</span>
                    </div>
                  )}
                </div>
              </div>
          ...
          >
            ...
            <div className="flex-1 w-full overflow-hidden flex justify-center py-10 print:py-0 print:block overflow-y-auto">
              {/* Giấy in (Paper container) với Zoom scale */}
              <div
              ...
              >
                ...
                <div className="text-center mb-10">
                  ...
                  <p className="text-sm text-gray-500">
                    {isRevenue ? "Ngày bán 01/05/2026" : "Tháng 05/2026"}
                  </p>
                </div>
