...
function StaffSetup() {
  ...
  const setupSteps = [
    {
      ...
      desc: "Bắt đầu thêm hồ sơ của nhân viên để quản lý hiệu quả.",
      btnText: "Thêm nhân viên",
    },
    {
      id: 2,
      title: "Tạo ca làm việc",
      desc: "Tạo các ca làm việc trong cửa hàng ( ví dụ : Ca sáng 8:00 - 12:00 ).",
      btnText: "Tạo ca",
    },
    {
      id: 3,
      title: "Xếp lịch làm việc",
      desc: "Xếp lịch làm việc cho nhân viên, tự động tạo lịch và hỗ trợ lập tuần.",
      btnText: "Xếp lịch",
    },
    {
      id: 4,
      title: "Hình thức chấm công",
      desc: "Chọn hình thức chấm công của cửa hàng (Dấu vân tay, Mã QR).",
      btnText: "Thiết lập",
    },
    {
      id: 5,
      title: "Thiết lập lương",
      desc: "Cấu hình các mục được ghi nhận lương, thưởng, phụ cấp.",
      btnText: "Thiết lập",
    },
    {
      id: 6,
      title: "Thiết lập bảng lương",
      desc: "Theo dõi chính xác và tự động tính lương của nhân viên.",
      btnText: "Tạo bảng lương",
    },
  ];
  ...
  const handleAddShift = () => {
    setShifts([
      ...shifts,
      { name: "Ca mới", in: "00:00", out: "00:00", total: "0h" },
    ]);
  };
      ...
      return (
        <td className="p-3" onClick={() => setSubModal({ type: typeKey, nv })}>
          <div className="cursor-pointer group">
            <div className="text-[13px] text-gray-800 font-medium group-hover:text-blue-600">
              {config.title}
            </div>
            <div className="text-[12px] text-gray-500 group-hover:text-blue-500">
              {config.subtitle}
            </div>
          </div>
        </td>
          ...
          <>
            <div className="p-6">
                ...
                <div className="mb-4">
                  ...
                  <div className="space-y-2 max-h-[150px] overflow-y-auto pr-2">
                    {employees.map((emp) => (
                      <div
                        key={emp.id}
                        className="flex justify-between items-center bg-gray-50 border border-gray-200 px-3 py-2 rounded-md"
                      >
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-gray-300 rounded-md px-3 py-2 outline-none focus:border-blue-500 bg-white text-[13px]"
                    />
                  </div>
                  <div>
                    <label className="block text-xs text-gray-600 mb-1.5 font-medium">
              ...
              <button
                ...
                className="text-blue-600 hover:text-blue-800 font-medium text-[13px] flex items-center gap-1 cursor-pointer"
              >
                + Thêm nhân viên
              </button>
            </div>
            <div className="px-6 py-4 border-t border-gray-200 flex justify-end gap-3 bg-gray-50">
              <button
                ...
                className="px-5 py-2 border border-gray-300 rounded-md text-gray-700 bg-white hover:bg-gray-50 cursor-pointer text-[13px] font-medium"
              >
                Bỏ qua
              </button>
              <button
                onClick={handleSaveStep1}
                className="px-6 py-2 bg-[#0066ff] hover:bg-blue-600 text-white rounded-md cursor-pointer text-[13px] font-bold shadow-sm"
              >
                Lưu và Tiếp tục
              </button>
            </div>
          ...
          <>
            <div className="p-6 bg-white">
                    ...
                    <tr key={idx} className="border-b border-gray-100">
                      <td className="py-3 pr-3">
                        <input
                          ...
                          value={shift.name}
                          onChange={(e) =>
                            handleShiftChange(idx, "name", e.target.value)
                          }
                      ...
                      <td className="py-3 pr-3">
                        <input
                          ...
                          value={shift.in}
                          onChange={(e) =>
                            handleShiftChange(idx, "in", e.target.value)
                          }
                          className="w-full border border-gray-300 rounded px-3 py-1.5 outline-none focus:border-blue-500"
                        />
                      </td>
                      <td className="py-3 pr-3">
                        <input
                          ...
                          value={shift.out}
                          onChange={(e) =>
                            handleShiftChange(idx, "out", e.target.value)
                          }
                          className="w-full border border-gray-300 rounded px-3 py-1.5 outline-none focus:border-blue-500"
                        />
                      </td>
                      ...
                      <td className="py-3 text-right">
                        <img
                          ...
                          alt="delete"
                          className="w-5 h-5 inline-block opacity-50 hover:opacity-100 cursor-pointer transition-opacity"
                        />
                      </td>
                    </tr>
                  ))}
              ...
              <button
                ...
                className="text-blue-600 hover:text-blue-800 font-medium text-[13px] flex items-center gap-1 mt-4 cursor-pointer"
              >
                + Thêm ca
              </button>
            </div>
          ...
          <>
            <div className="p-6 overflow-x-auto bg-white min-h-[300px]">
              <div className="flex items-center gap-2 mb-4 border border-gray-300 w-max rounded-md bg-white">
                <button className="px-2 py-1.5 hover:bg-gray-100 border-r border-gray-300 cursor-pointer">
                  &lt;
                </button>
                <span className="px-3 text-[13px] font-medium">
                  Tuần 5 - Th. 3 2026
                </span>
                <button className="px-2 py-1.5 hover:bg-gray-100 border-l border-gray-300 cursor-pointer">
                  &gt;
                </button>
              </div>
              <table className="w-full text-left border-collapse border border-gray-200 text-[13px]">
                <thead className="bg-white text-gray-600 font-medium border-b border-gray-200">
                  <tr>
                    <th className="p-4 border-r font-semibold min-w-[120px]">
                      Nhân viên
                    </th>
                    {days.map((day, idx) => {
                      ...
                      return (
                        <th
                          key={idx}
                          className="p-4 border-r text-center font-normal"
                        >
                ...
                <tbody>
                  {employees.length === 0 ? (
                    <tr>
                      ...
                      >
                        Chưa có dữ liệu nhân viên. Vui lòng quay lại Bước 1 để
                        thêm.
                      </td>
                    </tr>
                  ) : (
                      ...
                      >
                        ...
                        {days.map((day, idx) => {
                          const hasSchedule = schedules.find(
                            (s) => s.nvId === nv.id && s.date === day,
                          );
                          return (
                            <td
                              key={idx}
                              className="p-4 border-r align-top text-center group transition-colors hover:bg-gray-50"
                            >
                              {hasSchedule ? (
            ...
            <div className="p-6 space-y-4">
              <label className="flex items-start gap-3 cursor-pointer p-2 hover:bg-gray-50 rounded-md transition-colors">
                ...
                <div>
                  ...
                  <div className="text-gray-500 text-[13px]">
                    Hệ thống sẽ ghi nhận dữ liệu chấm công qua thiết bị quét vân
                    tay tại cửa hàng.
                  </div>
                </div>
              </label>
              ...
              <label className="flex items-start gap-3 cursor-pointer p-2 hover:bg-gray-50 rounded-md transition-colors">
                <input
                  ...
                  onChange={(e) =>
                    setAttendance({ ...attendance, qr: e.target.checked })
                  }
                  className="w-4 h-4 mt-0.5 accent-blue-600 cursor-pointer"
                />
                <div>
                  ...
                  <div className="text-gray-500 text-[13px]">
                    Nhân viên sử dụng điện thoại để quét mã QR định danh dán tại
                    cửa hàng để điểm danh.
                  </div>
                </div>
              </label>
            </div>
              ...
              <div className="flex gap-4 mb-4">
                <div className="flex-1 relative">
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-md pl-8 pr-3 py-1.5 text-[13px] outline-none focus:border-blue-500"
                  />
                  <img
                    src={Icons.Search}
                    alt="search"
                ...
                <select className="flex-1 border border-gray-300 rounded-md px-3 py-1.5 text-[13px] outline-none bg-white">
                  <option>Chọn chi nhánh</option>
                </select>
                <select className="flex-1 border border-gray-300 rounded-md px-3 py-1.5 text-[13px] outline-none bg-white">
                  <option>Tất cả loại lương</option>
                </select>
              </div>
                    ...
                    {employees.length === 0 ? (
                      <tr>
                        <td
                          ...
                          className="p-8 text-center text-gray-500 italic"
                        >
                          Chưa có dữ liệu. Vui lòng thêm nhân viên ở bước 1.
                        </td>
                      </tr>
                    ) : (
          ...
          <>
            <div className="p-6 space-y-5">
              <div>
                ...
                <select className="w-full border border-gray-300 rounded-md px-3 py-2 outline-none focus:border-blue-500 bg-white text-[13px]">
            ...
            <div className="px-6 py-4 flex justify-end gap-3 bg-gray-50">
              <button
                ...
                className="px-5 py-2 bg-[#0066ff] hover:bg-blue-600 text-white rounded-md cursor-pointer text-[13px] font-bold shadow-sm"
              >
                Tạo bảng lương
              </button>
            </div>
            ...
            <div className="p-6 space-y-6">
              {setupSteps.map((step) => {
                ...
                return (
                  <div
                    key={step.id}
                    className={`flex gap-4 items-start pb-6 border-b border-gray-50 last:border-0 last:pb-0 transition-opacity duration-300 ${isLocked ? "opacity-50 pointer-events-none select-none" : ""}`}
                  >
                    <div
                      className={`shrink-0 flex items-center justify-center w-6 h-6 rounded-full mt-0.5 text-xs font-bold transition-colors ${isCompleted ? "bg-white border-2 border-green-500 text-green-500" : isCurrent ? "bg-[#0066ff] text-white" : "bg-gray-300 text-white"}`}
                    >
                      {isCompleted ? "✓" : step.id}
                    </div>
                    <div className="flex-1">
                      <h3
                        className={`font-bold text-[14px] ${isCompleted || isCurrent ? "text-gray-900" : "text-gray-600"}`}
                      >
                        {step.title}
                      </h3>
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-5xl overflow-hidden flex flex-col max-h-[90vh]">
            <div className="flex justify-between items-center px-6 py-4 border-b border-gray-200 bg-white shrink-0">
              <h2 className="text-lg font-bold text-gray-900">
                {setupSteps.find((s) => s.id === openModalId)?.title}
              </h2>
              <button
                onClick={() => setOpenModalId(null)}
                className="text-gray-400 hover:text-red-500 text-2xl leading-none font-bold cursor-pointer transition-colors"
              >
                &times;
              </button>
            </div>
