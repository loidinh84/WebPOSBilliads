        ...
        <aside className="col-span-3 space-y-4">
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
            <div className="flex justify-between items-center mb-3">
              ...
              <img src={Icons.ArrowDown} alt="mũi tên" className="cursor-pointer"/>
            </div>
            <div className="space-y-2 text-sm">
              <label className="flex items-center gap-2"><input type="checkbox" /> Hàng thường</label>
              <label className="flex items-center gap-2"><input type="checkbox" /> Hàng chế biến</label>
              <label className="flex items-center gap-2"><input type="checkbox" /> Combo, gọi món</label>
              <label className="flex items-center gap-2"><input type="checkbox" /> Dịch vụ</label>
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
           ...
           <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
            ...
            <div className="space-y-2 text-sm">
              <label className="flex items-center gap-2"><input type="radio" /> Tất cả</label>
              <label className="flex items-center gap-2"><input type="radio" /> Dưới định mức tồn</label>
              <label className="flex items-center gap-2"><input type="radio" /> Vượt định mức tồn</label>
              <label className="flex items-center gap-2"><input type="radio" /> Còn hàng trong kho</label>
              <label className="flex items-center gap-2"><input type="radio" /> Hết hàng trong kho</label>
            </div>
          </div>
        </aside>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            <table className="w-full text-left text-sm border-collapse">
              ...
              <tbody>
                ...
                >
                  <td className="p-3 border-t font-medium text-blue-700">SP000012</td>
                  <td className="p-3 border-t font-medium">Snack tôm cay (Lớn)</td>
                  <td className="p-3 border-t text-right">Khác</td>
                  <td className="p-3 border-t text-right">15,000</td>
                  <td className="p-3 border-t text-right text-gray-400">9,000</td>
                        ...
                        <div className="flex-1 justify-end flex-col hidden lg:flex w-full">
                           ...
                           <div className="mt-12 flex gap-2 justify-end">
                              <button className="flex items-center justify-center gap-2 cursor-pointer bg-[#FF6600] text-white px-5 py-2 pl-0.5 pr-2 rounded-lg text-sm font-semibold hover:bg-[#e65c00] transition-all duration-200 shadow-sm min-w-[120px]"> 
                                ...
                                <span className="leading-none pt-0.5 whitespace-nowrap">Chỉnh sửa</span>
                                </button>
                              ...
                              <button className="bg-green-600 hover:bg-green-700 text-white px-4 py-1.5 pl-1.5 pr-2 rounded-lg flex items-center gap-1 cursor-pointer">
                                ...
                                <span className="whitespace-nowrap">Ngừng hoạt động</span>
                              </button>
