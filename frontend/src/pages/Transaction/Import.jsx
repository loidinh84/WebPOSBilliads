  ...
  const importInvoices = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          code: "SP0000022",
          name: "Bia Sài Gòn Special (Thùng)",
          qty: 2,
          price: 250000,
          discount: 0,
          importPrice: 250000,
      ...
      summary: {
        totalQty: 5,
        totalItems: 2,
        totalGoods: "1,700,000",
        invoiceDiscount: "0",
        finalTotal: "1,700,000",
        paid: "1,700,000",
      },
    },
    {
            ...
            <div className="space-y-3">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <input
                  ...
                  value="Hôm nay"
                  readOnly
                  className="flex-1 border border-gray-300 rounded px-3 py-1.5 bg-gray-50 text-gray-600 cursor-default"
                />
              </label>
          ...
          <div className="bg-white flex flex-col rounded shadow-sm border border-gray-200 overflow-hidden h-full">
                            ...
                            <td colSpan="5" className="p-0">
                              <div className="p-4 border-l-4 border-blue-500">
                                ...
                                <div className="flex gap-4 border-b border-gray-200 mb-4">
                                  <button className="pb-2 border-b-2 border-blue-600 font-medium text-blue-600 cursor-pointer">
                                    Thông tin
                                  </button>
                                  <button className="pb-2 text-gray-500 hover:text-gray-700 cursor-pointer">
                                    Lịch sử thanh toán
                                  </button>
                                </div>
                                  ...
                                  <div className="col-span-2 grid grid-cols-2 gap-y-3 text-sm">
                                    ...
                                    <div className="flex">
                                      ...
                                      <div className="flex items-center border border-gray-300 rounded px-2 py-0.5 bg-white">
                                        ...
                                        <div className="w-3 h-3 ml-2 opacity-50">
                                          <img
                                            src={Icons.Calendar}
                                            alt=""
                                ...
                                <div className="flex justify-end mt-4">
                                  <div className="w-80 space-y-2 text-right">
                                    ...
                                    <div className="flex justify-between">
                                      ...
                                      <span className="font-semibold">
                                        {invoice.summary.invoiceDiscount}
                                      </span>
                                    </div>
                                    <div className="flex justify-between">
            ...
            <div className="bg-white border-t border-gray-200 p-3 flex justify-start items-center text-gray-500">
              <div className="flex items-center gap-3">
                <button className="hover:text-blue-600 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed">
                  &laquo;
                </button>
                <button className="hover:text-blue-600 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed">
                  &lsaquo;
                </button>
                <button className="w-6 h-6 rounded bg-green-600 text-white font-medium flex items-center justify-center cursor-pointer">
                  1
                </button>
